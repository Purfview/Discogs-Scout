...
5.0.1   -    Added: Dance123, xprm

5.0.0   -    Auto-search works again on sites protected by Cloudflare challenge. [you must still pass the challenge by visiting the site]
             Note: Currently, partitioned cookies are supported only by Tampermonkey >=5.2.0.
             Updated @updateURL & @downloadURL to newish GreasyFork URLs.

4.1.0   -    Bugfix: 'mPOST' code failed for example on 'search=%tt%'
...
var public_sites = [
  ...
  {   'name': 'Core Radio',
      ...
      'bar': 2},
  {   'name': 'Dance123',
      'icon': 'data:image/png;base64,',
      'searchUrl': 'https://dance123.net/search?query=%band%+%release%',
      'loggedOutRegex': /Cloudflare|Ray ID/,
  ...
  {   'name': 'XDCC',
      ...
      'bar': 2},
  {   'name': 'xprm',
      'icon': 'data:image/png;base64,',
      'searchUrl': 'https://xprm.net/search/node/"%band%" "%release%"',
      'loggedOutRegex': /Cloudflare|Ray ID/,
      'matchRegex': /Your search yielded no results/,
      'spaceEncode': ' ',
      'bar': 2},
  {   'name': 'zHouse',
...
async function maybeAddLink(elem, site_name, search_url, site, scout_tick, band, release) {
  ...
  if ('mPOST' in site) {
    ...
    GM.xmlHttpRequest({
      ...
      url: search_url,
      cookiePartition: { topLevelSite: search_url },
      data: post_data,
